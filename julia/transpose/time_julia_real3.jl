...
include("compile_matrix01.jl")
include("compute_likelihood01.jl")
...
alpha = [1.0428542/2,1.0428542/2, 0.30345984/2, 0.30345984/2]*1.6467e-7
#alpha = [1.0428542]*1.6467e-7
alpha_real = alpha
...
# Now use the new slimmed-down real version:
  ...
  tic()
#  @code_warntype   compile_matrix01(alpha_final,beta_real_final,beta_imag_final,w0,t,nex_final,aex_final,al_small_final,indx_final)
  logdeta_final= compile_matrix01(alpha_final,beta_real_final,beta_imag_final,w0,t,nex_final,aex_final,al_small_final,indx_final)
  time_compute_final[it] = toq();
  tic()
#  @code_warntype   compute_likelihood(p_final,y,aex_final,al_small_final,indx_final,logdeta_final)
  log_like_final= compute_likelihood01(p_final,y,aex_final,al_small_final,indx_final,logdeta_final)
...
#  @code_warntype logdeta = lorentz_likelihood_hermitian_band_init(alpha,beta,w0,t,nex,aex,al_small,indx)
  ...
  println("Log Det, real: ",logdeta_real," hermitian: ",logdeta_hermitian," final: ",logdeta_final)
