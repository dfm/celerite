...
PYBIND11_MODULE(solver, m) {
  ...
  m.def("get_kernel_value",
    [](
      Eigen::Ref<const Vector>& a_real,
      Eigen::Ref<const Vector>& c_real,
      Eigen::Ref<const Vector>& a_comp,
      Eigen::Ref<const Vector>& b_comp,
      Eigen::Ref<const Vector>& c_comp,
      Eigen::Ref<const Vector>& d_comp,
