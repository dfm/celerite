...
density can be expressed as any general mixture of Lorentzian functions.
...
covariance function must be written as a mixture of Lorentzian functions in
Fourier space.
...
\section{Gaussian processes in one-dimension}
...
In the case of $p$ complex Lorentzians we can check for negative values of the PSD by solving for the
