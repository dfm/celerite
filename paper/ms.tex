...
This power spectrum matches that of our basis kernel if $\omega_0^2 = c_j^2+d_j^2$,
$a_jc_j-b_jd_j = 0$, $b_jd_j+a_jc_j=\omega_0^2$, and $4c_j^2 = \omega_0^2/Q^2$.
...
in Figure \ref{sho_psd} for various values of $Q$.  This power spectrum has
a peak frequency given by $\omega_{max} = \omega_0\sqrt{1-1/(2Q^2)}$, which is
...
The stochastically driven, damped simple-harmonic oscillator can then represent a wide range of intrinsic stellar variability, with
low $Q \approx 1$ representing granulation noise, and high $Q >> 1$ representing asteroseismic variability.
