...
\caption{A benchmark showing the computational scaling of the \celerite\
    implementation as a function of the number of data points and the number
    of terms.
    (left) The cost of computing \eq{gp-likelihood}
...
\caption{Benchmark\figurelabel{benchmark-lapack}}
\end{center}
\end{figure}
...
\caption{Benchmark\figurelabel{benchmark-sparse}}
\end{center}
\end{figure}
