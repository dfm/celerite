...
parameter matrix in definition of likelihood. Perhaps we should use W?}
...
%Gaussian process regression may also be used for prediction and interpolation at future or missing data, based upon current measurements.  With \celerite\ it proves possible to predict the mean value at times ${t_m; m=1,...,M}$ based upon measured times ${t_n; n=1,...,N}$ in $O(N+M)$ operations.
...
This is in good agreement with the literature value with smaller
uncertainties.
