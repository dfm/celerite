...
\end{eqnarray}
In this case, the inverse becomes more complicated but \eq{gp-likelihood} can
still be evaluated in $\mathcal{O}(J^2\,N)$ operations where $J$ is the number
of components in the mixture and $N$ is still the number of data points.
...
but we can start with one useful special case of this model.
