...
This power spectrum matches that of our basis kernel if $\omega_0^2 = b_r^2+b_i^2$,
$a_rb_r-a_ib_i = 0$, $a_ib_i+a_rb_r=\omega_0^2$, and $4b_r^2 = \omega_0^2/Q^2$.
...
\begin{equation}
K(\tau) = a_r e^{-b_r \vert\tau\vert} \left(\cos{(b_i \vert\tau\vert)} + \frac{b_r}{b_i}\sin{(b_i \vert\tau\vert)}\right),
\end{equation}
