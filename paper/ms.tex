...
variability.  Many astrophysical objects have a characteristic timescale
of variability which is determined by its physical structure. The variability
is excited by noisy physical processes, but also damped due to dissipation 
...
which are excited and damped by convective turbulence.
