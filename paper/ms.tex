...
We have derived a novel method for computing the Cholesky factorization of the
covariance matrices produced by \celeriteterm\ models.
In this section, we demonstrate the scalability and numerical performance of
this algorithm.
