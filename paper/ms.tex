...
\item The squared exponential kernel has the behavior of declining steeply at large
time separation, and has $c_1$ = 0.  An infinite number of exponential kernels may be used to
