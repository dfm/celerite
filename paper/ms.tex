...
\begin{figure}[!htbp]
\begin{center}
\includegraphics[width=0.75\textwidth]{figures/sho.pdf}
\caption{The power spectrum of a stochastically-driven simple harmonic
    ...
    \eq{lorentz-psd} with $c_j = 2\,Q = 20$ and normalized so that
    $S(d_j) = Q^2 = 100$.
    \figurelabel{sho}}
\end{center}
\end{figure}
