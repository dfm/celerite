...
given by $E(w,\Gamma) = e^{-\Gamma \sin^2{w}}$, which may be expanded as a series in $\cos{(2kw)}$,
...
This approximation is accurate to better than 0.5\% for $\Gamma < 3$.
\end{itemize}

{\color{red} Should we include some plots of these kernels, with the approximations?}
