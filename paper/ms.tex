...
c_j &=& \frac{\omega_0}{2Q}\\
d_j &=& \omega_0 \sqrt{1-\frac{1}{4Q^2}} \quad,
\end{eqnarray}
for $Q \ge \frac{1}{2}$.
For $Q < \frac{1}{2}$, \eq{sho-psd} can be captured by a pair of \genrp\ terms
with parameters
\begin{eqnarray}
a_{j\pm} &=& \frac{1}{2}\,\left[ S_0\,\omega_0\,Q \pm
        \frac{S_0\,\omega_0\,Q}{\sqrt{1-4\,Q^2}}\right] \\
b_{j\pm} &=& 0 \\
c_{j\pm} &=& \frac{\omega_0}{2Q} \pm \omega_0 \sqrt{\frac{1}{4Q^2}-1} \\
d_{j\pm} &=& 0 \quad.
\end{eqnarray}

This gives a kernel with dependence
